  ...
  <div class="container-fluid">
    <div class="row flex-nowrap">
        ...
        <div class="col py-3">
            <div class="contenido">
                <center>
                <h1>TWOT bienvenidos</h1>
                </center>
                <br>
                <br>
                <h3> 
                    Aqui podras encontrar los mejores precios del mercado de las herramientas y todo tipo de herramientas que esten a tu alcance
                </h3>
                <center>
                <div style="position: relative; overflow: hidden; padding-top: 56.25%;"><iframe src="https://share.synthesia.io/embeds/videos/c93926a0-00bd-43d4-bdd6-558eda581171" loading="lazy" title="Synthesia video player - Your AI video" allow="encrypted-media; fullscreen;" style="position: absolute; width: 50%; height: 50%; top: 0; left: 0; border: none; padding: 0; margin: 0; overflow:hidden;"></iframe></div> 
                </div>
                </center>
        </div>
    </div>
